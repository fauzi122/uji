...
class RekaplatihanujianController extends Controller
{
    ...
    public function index()
    {
        if (Auth::user()->utype == 'ADM') {
            ...
            $kelas = Jadwal::where('kd_dosen', Auth::user()->kode)->get();
            return view('admin.latihanujian.rekap.index', compact('kelas'));
        } else {
    ...
    public function show_mhs($id)
    {
        ...
        return view('administrasi.rekap.show_mhs', compact('showmhs'));
    }
    ...
    public function show_hasil($id_hasil)
    {
        ...
        return view('admin.latihanujian.rekap.hasilujian', compact('hasil', 'profil'));
    }
    ...
    public function show_rekap_kls($id)
    {
        ...
        // dd($jml_essay);
        return view('admin.latihanujian.rekap.listujian', compact('id', 'rekap', 'jml_essay'));
    }
    ...
    public function hasil_nilai_all($id)
    {
        ...
        $mahasiswa = app('App\Models\Hasilujian')->mhs($pecah[1]);

        $nilai_mhs = app('App\Models\Hasilujian')->nilai($pecah[0], $pecah[1]);

        $nilai_mhs_essay = app('App\Models\Hasilujian')->nilai_essay($pecah[0], $pecah[1]);

        $nilai_mhs_pg = app('App\Models\Hasilujian')->nilai_pg($pecah[0], $pecah[1]);

        return view('admin.latihanujian.rekap.nilaiall', compact(
            'nilai_mhs',
            'mahasiswa',
            'id',
            'nilai_mhs_essay',
    ...
    public function show_mhs_uji($id)
    {
        ...
        // dd($jawab_essay);
        return view('admin.latihanujian.rekap.jawabmhs', compact('id', 'jawab', 'profil', 'jawab_essay'));
    }
