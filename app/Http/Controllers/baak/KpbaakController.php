...
class KpbaakController extends Controller
{
    ...
    public function index()
    {
        ...
        //     $compect=['kampus'];
        // }
        return view('baak.kelaspengganti.kelaspengganti',compact('kuliah_pengganti'));

    }

    public function pengganti_side()
   {
        $kuliah_pengganti=DB::table('kuliah_pengganti')
        ...
        ->addColumn('alasan', function ($kuliah_pengganti) {
            
                $aksi='<div class="readmore">'.$kuliah_pengganti->alasan.'</div>';
        ...
        ->addColumn('acc', function ($kuliah_pengganti) {
            ...
            if ($kuliah_pengganti->sts_pengajuan=='1') {
                ...
                <a class="dropdown-item" href="'.url('/hapus-pengganti-baak/'.$id).'">Hapus</a>
            ...
            ->rawColumns(['sts_pengajuan','kelas','acc','alasan'])
            // ->rawColumns(['nomer'])
        ->make(true);
   ...
   public function acc_pengganti($id)
   {
    ...
    if ($cek<1) { // bukan teori
        ...
        ->update([
            ...
            return redirect('/cek-kuliah-pengganti-baak')->with('status','Terupdate');
   }
   public function hapus_pengganti($id)
   {
    ...
    if ($cek<1) { // bukan teori
        ...
        ->delete();
            ...
            return redirect('/cek-kuliah-pengganti-baak')->with('status','Terhapus');
   }
   ...
   public function edit($id)
    ...
    if ($cek<1) { // bukan teori
        ...
        return view('baak.kelaspengganti.form_pengganti',compact('jadwal'));
