...
class DetailSoalEssay_ujian extends Model
{
  use LogTrait;
  protected $guarded = [];

  protected $table = 'ujian_detail_soal_esays';
  ...
  {
    return $this->hasOne(JawabEsay::class, 'id_detail_soal_esay', 'id')->where('id_user', auth()->user()->username);
  }
