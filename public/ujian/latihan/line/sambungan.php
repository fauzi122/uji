...
if($db_pt=="1"){
	...
	$db_prefix='b51';
	$path_base='../latihan/';
	//ujian/latihan/content.php?page=login
	$path_file='http://ujiankampus.bsi.ac.id/ujian/latihan';
	//$path_file='http://ujian.kampus.id/ujian/latihan';
...
$connect=mysql_connect($host,$user,$pass) or die ('Internal Server Error 505');
mysql_select_db($db,$connect) or die ('Maintenance Server');
