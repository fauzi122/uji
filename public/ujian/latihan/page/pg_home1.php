...
var currenttime = '<?php date_default_timezone_set('
Asia / Jakarta ');
echo date("F d, Y H:i:s", time()) ? > ' //SSI method of getting server date
...
<div class="col-md-3">
    <div class="block-web">
                    ...
                    <div class="thumbnail" style="border:none !important;">
                        <center>
                            <div class="thumbnail-view">
                                ...
                                <img alt="<?php echo $nama; ?>" src="<?php echo $fotoavatar; ?>"
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" class="table table-hover">
            ...
            <tr>
                <td align="left">
                    <div style="font: 12px Georgia; color:#000000;">
                        <?php echo $hari_ini . ",  " . $tgl_skrg . "-" . $bln_sekarang . "-" . $thn_sekarang; ?></div>
                </td>
                <td align="left">
                    <div style="font: 12px Georgia; color:#000000;">
            ...
            <tr>
                <td colspan="6">
                    <p style="font: 12px Georgia; color:#000;line-height:2;">
                        " Jika sudah masuk jam ujian link ujian belum juga tampil harap refresh browser anda atau tekan
                        tombol F5 "
    ...
    <div class="block-web">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="table">
            ...
            window.setTimeout(function() {
                alert('Ujian <?php echo $krs['
                    test_description ']; ?> di Mulai');
            ...
            <tr>
                ...
                <td style="text-align:center;"><?php echo $datestart;
                            ...
                            if ($num_tamp['test_attempt_count'] == $krs['test_attempts'] or $num_tamp['test_attempt_count'] > $krs['test_attempts'] and $num_rasw > 0) {
                                /*if($krs['test_type']==1){
											if($krs['test_dateend']>$unix_timestamp){
													?>
                <td>
                    <form action="edit-<?php echo base64_encode($id_user); ?>" method="post" style="margin:0;padding:0;"
                        name="edit-<?php echo $krs['testid'];?>">
                ...
                <?php
											...
											?>
                <td>
                    <form action="bukti-ujian-<?php echo base64_encode($id_user); ?>" method="post"
                        style="margin:0;padding:0;" name="bukti-ujian-<?php echo $krs['testid'];?>">
                        <input type="hidden" name="userid" value="<?php echo $nim; ?>">
                        <input type="hidden" name="testid" value="<?php echo $krs['testid']; ?>">
                ...
                <?php }
                            ...
                            ?>
                <td>
                    <form action="bukti-ujian-<?php echo $s_id; ?>" method="post" style="margin:0;padding:0;"
                        name="bukti-ujian">
                        <input type="hidden" name="userid" value="<?php echo $nim; ?>">
                        <input type="hidden" name="testid" value="<?php echo $krs['testid']; ?>">
            ...
            <tr>
                <td colspan="5">
                    <center>Tidak ada jadwal ujian di KRS anda</center>
                </td>
