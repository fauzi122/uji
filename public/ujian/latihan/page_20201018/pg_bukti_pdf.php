...
$pdf->SetAuthor('Ujian Online');
$pdf->SetTitle('Bukti Ujian Online');
$pdf->SetSubject('Bukti Ujian Online PDF');
$pdf->SetKeywords('Bukti, Ujian, PDF');
...
<tr><td width="10%"></td><td width="20%" style="background-color:#c7c7c7;">  Lama Waktu <br>&nbsp;&nbsp;Mengerjakan</td><td style="background-color:#c7c7c7;">:  </td><td width="59%" style="background-color:#c7c7c7;">$spenttime</td><td width="10%"></td></tr>
</table>
<br><br>
...
$pdf->write2DBarcode($s_code, 'QRCODE,H', 90, 162, 30, 30, $style, 'N');
// CODE 128 A
...
while($l_cekresultans=mysql_fetch_array($q_cekresultans)){
	if($list_bkt['test_type']==1){
		$pdf->SetFillColor(255, 255, 255);
		$pdf->MultiCell(10, 5, '', 0, 'C', 1, 0, '', '', true);
		$jawaban=substr($l_cekresultans['result_answer_text'],0,2500);
$jawabhtml = <<<EOD
$jawaban .......
EOD;
