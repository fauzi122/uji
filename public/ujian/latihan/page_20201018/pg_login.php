            ...
            <div class="porlets-content">
                ...
                <div class="form-group">
				  ...
				  <select name="ptinggi" class="form-control" id="show">
					...
					<option value="1">UNIVERSITAS BINA SARANA INFORMATIKA&nbsp;&nbsp;&nbsp;</option>
            ...
            <div class="tab-content"> 
              <div id="about" class="tab-pane active animated fadeInRight">
                <div class="user-profile-content"> <!--style="overflow-y:scroll;height:400px;"-->
				  ...
				  <ol>
					<li>Aktifkan laptop/notebook anda koneksikan ke internet lalu akses halaman <a href="http://ujiankampus.bsi.ac.id">http://ujiankampus.bsi.ac.id</a></li>
					<li>Untuk dapat masuk ke Sistem Ujian Online, masukan NIM dan password anda tanggal lahir format(yyyy-mm-dd), jika Anda memilih perguruan tinggi dan memasukan user dan password dengan benar maka Sistem Ujian akan membawa anda pada daftar Matakuliah Ujian Anda (KRS) </li>
					<li>Pada daftar matakuliah ujian Anda link ujian akan dapat diklik apabila tanggal dan jam ujian sudah memasuki waktu ujian serta Durasi Pengerjaan Soal Selama 60 Menit</li>
