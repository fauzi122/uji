...
<div class="col-md-3">
	<div class="block-web">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" class="table table-hover">
			...
			<tr>
				<td align="left">
					<div style="font: 12px Georgia; color:#000000;"><?php echo $hari_ini . ",  " . $tgl_skrg . "-" . $bln_sekarang . "-" . $thn_sekarang; ?></div>
				</td>
				<td align="left">
			...
			<tr>
				<td colspan="6">
					...
					<p style="font: 12px Georgia; color:#FF0000;line-height:2;">
						<!-- <h4> Untuk Ujian Durasi Pengerjaan Soal Adalah 1 Jam (60 Menit), Dimulai Saat Pertama Kali Mengklik Tombol "Mulai Ujian"  -->
						</h4>
					</p>
				</td>
			</tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" class="table">
			...
			?>
					...
					<tr>
						...
						<td style="text-align:center;"><?php echo $krs['ruang']; ?></td>
