          ...
          <div class="col-md-12">
			...
			<?php
				...
				// Apabila username dan password ditemukan
					 if ($ketemu > 0){
						 	echo "<script>window.alert('$nip dan $password');</script>";
						if($r['sts_bayar']=='0'){
							?>
							...
							<?php
								...
								/*	 <?php echo "Rp ".number_format($r['jml_kurang'],2,'.',','); ?>// Membaca IP dan Hostname User
								...
								if($numslogin<1 or $list_rowlog['hits']>0){
									mysql_query("INSERT INTO ".$db_prefix."visitors
												(startdate,
												 enddate,
												 userid,ip1,ip2,ip3,ip4,host,useragent,referer,inurl)
										VALUES ('$unix_timestamp',
												'$unix_timestamp',
												'$r[userid]','$ipexpl[0]','$ipexpl[1]','$ipexpl[2]','$ipexpl[3]','ip:$ip - hostname:$hostname - macaddrs:$mac','$useragent','$path_base','$referer'
												)");
								} */
					...
					?>
						<div class="alert alert-danger alert-dismissable">
						  ...
						  <h4><strong>Peringatan!</strong></h4>
						   User atau Password login anda tidak ditemukan.
						</div> 
					<?php 
					}
				}
            ...
            <div class="porlets-content">
                ...
                <div class="form-group">
				  ...
				  <select name="ptinggi" class="form-control" id="show">
					...
					<option readonly value="1">Universitas Bina Sarana Informatika &nbsp;&nbsp;&nbsp;</option>
					<!-- 	<option value="2">Universitas BSI Bandung</option> -->
					<!--option value="3">STMIK Nusa Mandiri Jakarta</option-->
            ...
            <div class="tab-content"> 
              <div id="about" class="tab-pane active animated fadeInRight">
                <div class="user-profile-content"> <!--style="overflow-y:scroll;height:400px;"-->
				  ...
				  <ol>
					<li>Aktifkan laptop/notebook anda koneksikan ke internet, lalu akses<a href="http://ujiankampus.bsi.ac.id/ujian/login"> ujiankampus.bsi.ac.id</a></li>
...
<!-- AKTIFITAS - START -->
		...
		<div class="thumbnail-footer" style="font-size:11px;">
            <div class="pull-left"> &copy; 2022 Sistem Informasi Akademik<br> Powered By <font style="color:#115992;">Universitas Bina Sarana Informatika</font> </div>
