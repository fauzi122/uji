...
document.location = '<?php echo $path_base . "-" . $s_id; ?>';
</script>
...
.modal-title {
    background: url('<?php echo "images/" . $web_logo; ?>') no-repeat;
        ...
        <div class="modal-content">
            <div class="modal-header">
                <a type="button" class="close" aria-hidden="true"
                    href="<?php echo $path_base . "-" . $s_id; ?>">&times;</a>
                <p class="modal-title">&nbsp;<font><strong><?php echo $web_title; ?></font>
                </p>
            </div>
            <div class="modal-body">
                <table>
                    <tr>
                        <td>
                            <h2><?php echo $list_bkt['test_name']; ?></h2>
                        </td>
                    </tr>
                    <tr>
                        <td>Tanggal Ujian : <?php echo $datestart;
													if ($datestart <> $dateend) {
														echo " s/d " . $dateend;
													} ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jam Ujian :
                            <?php echo $list_bkt['mulai'] . " - " . $list_bkt['selesai']; ?></td>
                    </tr>
                    <tr>
                        <td>Lama Waktu Mengerjakan :
                            <?php echo $diff->h . ' Jam ' . $diff->i . ' Menit ' . $diff->s . ' Detik'; ?></td>
                        <!-- <td>Lama Waktu Mengerjakan : <?php echo $list_bkt['spent_time']; ?></td> -->
                    </tr>

                    <tr>
                        <td>Mulai Ujian : <?= $list_bkt['awal'];  ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Selesai Ujian
                            :
                            <?php if ($waktu_habis['waktu_habis'] == '1') {
										// echo $list_bkt['akhir2'] ;
										echo $cenvertedTime = date('H:i:s', strtotime('+1 hour', strtotime($list_bkt['awal'])));
									} else {
										echo $list_bkt['akhir'];
									}
									?>
            ...
            <div class="modal-footer">
                ...
                <form action="bukti-pdf-<?PHP echo $s_id; ?>" method="post" style="margin:0;padding:0;" name="bukti"
                    target="_blank">
