...
if ($nim=="" or $test_id==""){
	...
	<?php
		...
		$q_cekresult=mysql_query("SELECT resultid, result_points, result_datestart FROM ".$db_prefix."results WHERE testid='$test_id' AND userid='$nim' ORDER BY resultid DESC  LIMIT 1");
...
<div class="col-md-12">
	<div class="block-web">
		...
		<div class="row" style="background:#363B3F;padding:15px;color:#fff;">
			...
			<div class="col-md-4"><a href="bukti-ujian<?php echo "-".$s_id;?>" class="btn btn-primary" style='font-weight:bold;border:#407b9b solid 1px !important;background:#f7f7f9 !important;color:#407b9b !important;'>Selesai Ujian</a></div>
			<div class="col-md-4">
		...
		?><tr>
			...
			<div style="max-height:400px;overflow-y:auto;">
				...
				if($question['question_pre']<>""){ //Soal gambar ?>
					<img src="Image/<?php echo $question['question_pre'];?>" style="max-width:100%;"><br>
				<?php }
			...
			<td>
				<form action="eujian-<?php echo $s_id; ?>" method="post" style="margin:30px 0px;" name="eujian-<?php echo $krs['testid'];?>">
		...
		<div  class="row" style="background:#363B3F;padding:15px;color:#fff;"> <center><a href="bukti-ujian<?php echo "-".$s_id;?>" class="btn btn-primary" style='font-weight:bold;border:#407b9b solid 1px !important;background:#f7f7f9 !important;color:#407b9b !important;'>Selesai Ujian</a></center></div>
