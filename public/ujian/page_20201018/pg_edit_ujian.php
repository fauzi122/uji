...
if($questionid==""){
	...
	<?php
		...
		$q_testuser=mysql_query("SELECT testid, test_datestart, test_dateend, jmlsoal, test_time, test_type, test_shuffleq, test_shufflea FROM ".$db_prefix."tests WHERE testid='$test_id' ");
			...
			<?php
				...
				if($list_q['question_type']=='1'){
					...
					/*$q_answer=mysql_query("SELECT
											...
											ORDER BY RAND()");*/
					$query_qa = "SELECT a.answerid, a.answer_text, b.result_answer_text";
					$query_qa .= " FROM ".$db_prefix."answers AS a, ".$db_prefix."results_answers AS b";
					$query_qa .= " WHERE a.questionid=b.questionid AND a.questionid = '$list_q[questionid]' AND b.resultid='$list_q[resultid]'";
					////////////////// QUERY RANDOM ANSWER /////////////////////
					if($list_test['test_shufflea'] == '1'){
					$query_qa .= " ORDER BY RAND()";
					}else{
					$query_qa .= " ORDER BY a.answerid ASC";
					}
					///////////////////////////////////////////////////////////
