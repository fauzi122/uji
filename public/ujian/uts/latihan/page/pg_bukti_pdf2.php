<?php
	...
	$nim = mysql_real_escape_string(base64_decode($_GET["id1"]));
	$test_id = mysql_real_escape_string(base64_decode($_GET["id2"]));
...
<div id="aplikasicetak">
		<div class="ahead" align="center">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-bottom:10px;border-bottom:#000 solid 1px;">
			  <!--DWLayoutTable-->
			  <tr > 
				<td width="120" rowspan="3"> <div align="left" style="margin-left:10px;"><img src="img/logo bsi_150.png" width="100" height="100" align="middle"></div></td>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF" align="center"><font face="Verdana, Arial, Helvetica, sans-serif">&nbsp; </font><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><tr> 
          <td colspan="3" align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="-4">Tanggal Cetak: <?php echo $tgl_sekarang; ?> - Jam Cetak: <?php echo $jam_sekarang;?> <br> <i>ScurityCode: <?php echo $s_code; ?></i></font></td>
        </tr></font></td>
    </tr>
  </table>
