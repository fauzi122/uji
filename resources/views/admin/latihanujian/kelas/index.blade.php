                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/show/class/{{ $id }}" class="btn btn-sm btn-info">
                                                <i class="icon-users" title="lihat data siswa"></i>
                                                siswa
                                            </a>
                                              <a href="/show/kelas/{{ $id }}" class="btn btn-sm btn-primary">
                                                <i class="icon-file" title="rekap latihan ujian"></i>
                                                rekap
                                            </a>
                                             {{--  @endcan   --}}
