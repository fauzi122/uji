                ...
                <div class="card-body p-0">
                    <div class="invoice-container">
                        <div class="invoice-header">
                            {{-- @php $id=Crypt::encryptString($soal->id); @endphp --}}
                        </div>
                                        ...
                                        <table id="myTable1" class="table custom-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($hasil->score == 0)
                                                        <center><span class="badge badge-secondary">Salah</span></center>
                                                        @else
                                                        <center><span class="badge badge-info">Benar</span></center>
                                                        @endif
                                                    </td>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-4">
                        <div class="alert-notify info">
                            <div class="alert-notify-body">
                                ...
                                <div class="alert-notify-title">Info Aktivitas <img src="img/notification-info.svg" alt=""></div>
                                <div class="alert-notify-text">
                                    Data yang ditampilkan merupakan aktivitas yang dilakukan oleh mahasiswa yang bernama <b>{{ $profil->name ?? '-' }}</b>
                                    <p></p>
                                    soal yang diterbitkan oleh bapak/ibu sesuai mata kuliah yang diampuh dan diajarkan
                                    <br>
                                </div>
                            </div>
                        </div>
