...
<div class="main-container">
      ...
      <div class="modal-content">
        <div class="modal-header">
                <h5 class="modal-title" >FORM SEKAPUR SIRIH PEMBELAJARAN - {{ $materi->nm_mtk }}</h5>
            ...
            <div class="modal-body">
                ...
                <form class="row gutters" action="/spa-store" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group mb-0">
                            <label for="docDetails">Pertemuan ke-</label>
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group mb-0">
                            <label for="docDetails">Biodata Diri</label>
