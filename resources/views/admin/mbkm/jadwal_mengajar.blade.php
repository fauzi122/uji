            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="pricing-plan">
                    ...
                    <div class="card-body">
                        ...
                        @endphp
                        <form action="/create-gabung-mbkm" method="post">
                        @csrf
                        ...
                        <input type="hidden" name="kd_lokal_mbkm" value="{{$jad->kd_lokal_mbkm}}">
                    ...
                    @elseif($jad->kel_praktek=='')
                        ...
                        @endphp
                        <form action="/create-teori-mbkm" method="post">
                            @csrf
                            <input type="hidden" name="kd_mtk" value="{{$jad->kd_mtk}}">
                            <input type="hidden" name="nm_mtk" value="{{$jad->nm_mtk}}">
                            <input type="hidden" name="kd_dosen" value="{{$jad->kd_dosen}}">
                     ...
                     <form action="/create-praktek-mbkm" method="post">
                        @csrf
                        <input type="hidden" name="kd_mtk" value="{{$jad->kd_mtk}}">
                        <input type="hidden" name="nm_mtk" value="{{$jad->nm_mtk}}">
                        <input type="hidden" name="kd_dosen" value="{{$jad->kd_dosen}}">
