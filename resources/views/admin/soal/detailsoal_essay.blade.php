								...
								<div class="card-body p-0">
									<div class="invoice-container">
                                            ...
                                            <div class="row gutters">
                                                ...
                                                <audio controls>
                                                  <source src="{{ Storage::url('public/soalessay/'.$detailsoal->file) }}" type="audio/mpeg">
                                                  Browsermu tidak mendukung tag audio, upgrade donk!
                                                </audio>
                                              @else
                                              <img src="{{ Storage::url('public/soalessay/'.$detailsoal->file) }}" class="img-thumbnail" height="300" width="300">
                                                 @endif
										                            </div>
                                                  @else
									      ...
									      <a href="/edit-essay/soal/{{$detail_essay}}" class="btn btn-success">Edit</a>
