...
<!-- Content wrapper start -->
				<div class="content-wrapper">
                    ...
                    @endphp
									<a href="/toef-create-pilih/{{$id}}" class="btn btn-success">Input Soal Pilihan Ganda</a>
                  ...
                  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#basicModal">
                    ...
                    @if (session('success'))
                         ...
                         <form action="/toef-upload-soalpg" method="post" enctype="multipart/form-data">
                            @csrf
                                  ...
                                  <hr>
                                    ...
                                    <table id="myTable2" class="table custom-table">
                                     ...
                                     <p></p>
                                       ...
                                       @else
                                        <center>
                                        <a href="/toef-detail/soal-show/{{$detail}}"> <span class='badge badge-pill badge-info'>audio/img</span>
                                        </a>
                                        </center>
                                     ...
                                     @if ($soals->url != null)
                                    <br>
                                      <a href="{{ $soals->score }}" target="_blank" class="audio-button">
                                    ...
                                    @endif
                                     ...
                                     <td>
                                       ...
                                       <a href="/toef-edit-detail/soal/{{$detail}}" class="btn btn-sm btn-success">edit</a>
                                       <a href="/toef-detail/soal-show/{{$detail}}" class="btn btn-sm btn-info">show</a>
                        ...
                        @endphp
                        	...
                        	<a href="/toef-create-essay/{{$id}}" class="btn btn-success">Input Soal Essay</a>
									...
									<div class="modal fade" id="basicModal1" tabindex="-1" role="dialog" aria-labelledby="basicModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
                         <form action="/toef-upload-soalessay" method="post" enctype="multipart/form-data">
                            @csrf
                                   ...
                                   <table id="copy-print-csv" class="table custom-table">
                                     ...
                                     @endif
                                      ...
                                      <p></p>
                                       ...
                                       @else
                                        <center>
                                        <a href="/toef-essay/soal-show/{{$detail_essay}}"> <span class='badge badge-pill badge-info'>audio/img</span>
                                        </a>
                                        </center>
                                  ...
                                  <div class="card-body">
                                    <div class="btn-group">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="/toef-edit-essay/soal/{{$detail_essay}}">Edit</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="/toef-essay/soal-show/{{$detail_essay}}">Show</a>
                                      </div>
                                    </div>
                                     </td>
