                                   ...
                                   <table id="copy-print-csv" class="table custom-table">
                                     ...
                                     @endif  --}}
                                      ...
                                      <p></p>
                                       ...
                                       @else
                                        <center>
                                        <a href="/edit-essay/soal-uts/{{$detail_essay}}"> <span class='badge badge-pill badge-info'>cek gambar</span>
                                        </a>
                                        </center>
                                     ...
                                     <td>
                                      <center>
                                        <div class="btn-group" role="group">
                                          ...
                                          @if ($essay->sts_kirim == 1 || $essay->sts_kirim == 2)
                                           
                                         
                                           @else
                                            <a class="dropdown-item" href="/edit-essay/soal-uts/{{$detail_essay}}">Edit Data Soal</a>

                                           @endif
                                             
                                            <a class="dropdown-item" href="/essay/soal-show-uts/{{$detail_essay}}">Show Data Soal</a>
                                          </div>
                                      </div>
                                                         
                                      {{--  <a href="/edit-essay/soal-uts/{{$detail_essay}}" class="btn btn-sm btn-success">edit</a>
                                      <a href="/essay/soal-show-uts/{{$detail_essay}}" class="btn btn-sm btn-info">show</a>  --}}
                                      </center>
                                     </td>
                      ...
                      <table class="table table-condensed table-bordered table-hover">                
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $soal->mtkUjian->nm_mtk ?? 'Data tidak tersedia' }}</td>
                            </tr>
