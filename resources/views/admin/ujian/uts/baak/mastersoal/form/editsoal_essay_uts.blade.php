        ...
        <div class="row gutters">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/baak/uts-essay/update/{{ $editsoal->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    oninput="setCustomValidity('')">{{ old('soal', $editsoal->soal) }}</textarea>
                          @error('soal')
                          ...
                          @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="summernote3" class="form-control content @error('kunci') is-invalid @enderror" name="kunci" required
                                              oninvalid="this.setCustomValidity('Silahkan isi artikel')"
                                              oninput="setCustomValidity('')">{{ old('kunci', $editsoal->kunci) }}</textarea>
                                    @error('kunci')
                                    <div class="invalid-feedback" style="display: block">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label><input type="radio" name="status" id="n" value="T" @if ($editsoal->status == "N") checked @endif> Tidak tampil</label>
                                </div>
                            </div>
