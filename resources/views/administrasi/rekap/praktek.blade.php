...
<div class="main-container">
    <div class="table-container">
        <div class="alert alert-info" role="alert">
            <h4 class="alert-heading">Rekap Ajar Praktek</h4>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="rekap-kampus-tab" data-toggle="tab" href="#rekap-kampus" role="tab" aria-controls="rekap-kampus" aria-selected="true">Rekap Ajar Praktek Per Kampus Per Hari</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="rekap-teori-tab" data-toggle="tab" href="#rekap-teori" role="tab" aria-controls="rekap-teori" aria-selected="false">Rekap Ajar Praktek Per Hari Semua Kampus</a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="rekap-teori" role="tabpanel" aria-labelledby="rekap-teori-tab">
                        ...
                        <table id="copy-print-csv" class="table custom-table">
                            <thead>
                                <tr style="background-color: #4e303e" class="text-white">
