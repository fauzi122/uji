							   ...
							   <div class="modal-dialog" role="document">
								   <div class="modal-content">
									   ...
									   <div class="modal-body">
										   <form class="row gutters" method="post" action="/tambah-diskusimhs" enctype="multipart/form-data">
											   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												   <div class="form-group mb-0">
													   ...
													   <div class="invalid-feedback">{{ $message }}</div>
													   @enderror
													   <label class="label">File Tambahan</label>
									   ...
									   <section class="task-list">
										   ...
										   <div class="task-block">
											   ...
											   <div class="task-details">
												   ...
												   <form action="/download-file-diskusimhs" method="post">
												   ...
												   <div class="task-types">
													   ...
													   <form action="/hapus-diskusimhs/{{$ct->id_chat}}" method="post" id="delete-post-form">
														   @method('delete')
														   @csrf
											   ...
											   <form action="/form-komentarmhs" method="POST">
												   @csrf
												   <input type="hidden" name="id_chat" value="{{$ct->id_chat}}">
												   <input type="hidden" name="id" value="{{$id}}">
											   ...
											   @endphp
											   <a href="/form-komentarmhs/{{$kombinasi}}" class="btn btn-info btn-rounded">Komentar <span class="badge badge-pill badge-danger">{{$ct->jml}}</span></a>
