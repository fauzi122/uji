...
<div class="row gutters">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="info-tiles">
            ...
            @if ($komentar < 1) {{-- Cek apakah mahasiswa sudah memberikan komentar --}} @php $cryp_pertemuan=Crypt::encryptString($absen->first()->pertemuan.',1,'.$absen->first()->nip.','.$pengganti.',');
                @endphp
                ...
                @php
                $cryp_pertemuan = Crypt::encryptString($absen->first()->pertemuan.',1,'.$absen->first()->nip.','.$pengganti.',');
                @endphp
