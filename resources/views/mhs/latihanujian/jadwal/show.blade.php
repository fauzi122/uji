                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="alert alert-primary d-flex align-items-center" role="alert">
                                                                    ...
                                                                    @if (substr($data->file,-3)=='mp3')
                                                                        <audio controls>
                                                                            <source src="{{ Storage::url('public/soal/'.$data->file) }}" type="audio/mpeg">
...
{{--  <button id="next">Next</button>  --}}
	<a href="/selesai-ujian/{{$id}}" class="btn pull-left selesai" id="selesai" style="display: none; background-image: linear-gradient(to right, #4cf315 , #04bd20); border: none; color: #fff;">Selesai Ujian</a>
...
<script src="{{ url('js/jquery-ujian.js?v=5') }}"></script>
