           ...
           <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
            <p>
              ...
              <div class="content-wrapper">
                ...
                @php
                    $data = file_get_contents("http://students.bsi.ac.id/mahasiswa/api-azis_{$slidemhs->kd_dosen}_{$slidemhs->jam_t}_{$slidemhs->hari_t}.html"); 
                    $xxx=json_decode($data,TRUE);  
                @endphp
                      <div class="doc-title">Silabus</div>
                      <a href="http://students.bsi.ac.id/mahasiswa/silabus/102.zip" class="btn btn-primary btn-lg">Download</a>
                      {{--  <a href="" class="btn btn-primary btn-lg">Download</a>  --}}
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="doc-block">
                      ...
                      <div class="doc-title">RPS</div>
                      <a href="http://students.bsi.ac.id/mahasiswa/sap/{{$xxx['kd_gbg']}}.zip" class="btn btn-primary btn-lg">Download</a>
                      {{--  <a href="" class="btn btn-primary btn-lg">Download</a>  --}}
                    </div>
                  </div>
