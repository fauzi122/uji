									...
									<div class="card text-center">
                                        ...
                                        <center>
                                            @if($soals->count())
                                                ...
                                                <span class="no_soal badge badge-pill  {{ $data_number->checkJawab == true ? 'badge-primary' : 'badge-light' }}" id="{{ 'nav'.$data_number->id }}" data-id="{{ $data_number->id }}" data-no="{{ $key_number+1 }}" data-random="{{ $data_number->checkJawab == true ? false:true }}"><a href="#">{{ $key_number+1 < 10 ? '0':'' }}{{ $key_number+1 }}</a></span>
                                                @endforeach
                                            @endif
                                            </center>
											</div>
